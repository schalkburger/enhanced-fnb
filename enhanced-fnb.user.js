@-moz-document domain("fnb.co.za") {
   /* Hide elements */
    ...
    body > div.section.height2.headerTabs.backTurq,
    body > div.section.height2.headerTabs.backTurq > div,
    div.loginFields ~ div.wrapperFloatRight,
    .slide,
    ...
    .backTurq,
    .overlay .section .section.backTurq {
    background: #00999b;
    }
